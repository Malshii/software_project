            ...
            >
                <Box sx={{ bgcolor: 'background.paper', width: '75%', m: 'auto' }}>
                    <Typography component="h1" variant="h5">
                        Register a Lab Assistant
                    </Typography>
                    <Grid container mt='20px' mb='40px' >
                        <Grid item md={8} margin='auto'>
                            <Typography align='center' variant="subtitle2" >Enter the basic information of the Lab Assistant to register. An email will be sent to reset the password.</Typography>
                        </Grid>
                    </Grid>
...
export default LabAssistantManagement;
