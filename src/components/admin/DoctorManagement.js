                ...
                <Box sx={{ bgcolor: 'background.paper', width: '75%', m: 'auto' }}>
                    ...
                    <Grid container mt='20px' mb='40px' >
                        <Grid item md={8} margin='auto'>
                            <Typography align='center' variant="subtitle2" >Enter the basic information of the Doctor to register. An email will be sent to reset the password.</Typography>
                        </Grid>
                    </Grid>
