...
export default function RegisterReceptionist() {
    ...
    function sendData(e){
      ...
      axios.post("http://localhost:4000/receptionist/recSignup",newReceptionist).then(()=>{
  ...
  return(
    ...
    <Header/>
      ...
      <form onSubmit={sendData}>      
        ...
        <h6 class="text-center">Already an account? <a href="/ReceptionistLogin">Login here</a></h6>
      </form>
      </div>
